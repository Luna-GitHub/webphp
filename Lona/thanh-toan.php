<?php 
    ...
    {
        echo " <script>alert(' Đăng nhập rồi quay lại đây');location.href='dang-nhap.php' </script> ";
    }
	...
	if($_SERVER["REQUEST_METHOD"] == "POST")
	{
		...
		if($idtran > 0)
		{
			...
			$_SESSION['success'] = "Đặt hàng thành công. Cảm ơn quý khách đã tin tưởng mua hàng tại Cafe Đợi";
            ...
            <section class="box-main1">
                ...
                <form action="" method="POST" class="form-horizontal formcustome" role="form" style="margin-top: 20px">
            		...
            		<div class="form-group">
            			...
            			<div class="col-md-5">
            				<input type="text"  readonly="" name="name" placeholder=" Tên " class="form-control" value="<?php echo $user['name'] ?>">		
            			</div>
            		</div>
            		<div class="form-group">
            			<label class="col-md-2 col-md-offset-1"> Email</label>
            			<div class="col-md-5">
            				<input type="email"  readonly="" name="email" placeholder=" ...@gmail.com" class="form-control" value="<?php echo $user['email'] ?>">
            		...
            		<div class="form-group">
            			...
            			<div class="col-md-5">
            			<input type="number" readonly="" name="phone" placeholder="+84" class="form-control" 
