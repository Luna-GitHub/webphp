<?php 
    ...
    {
        echo " <script>alert('Giỏ hàng rỗng');location.href='main.php' </script> ";
    }
?>
    ...
    <section class="box-main1">
        ...
        <table class="table table-hover" id="shoppingcart_info">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><img src="public/uploads/product/<?php echo $value['thunbar'] ?>" width="80px" height="60px" style="border-radius:20px"
                            alt=""></td>
                    <td>
                        <input type="number" name="qty" value="<?php echo $value['qty'] ?>" class="form-control"
                            id="qty" min="0">
                    </td>
                    ...
                    <td>
                        ...
                        <a href="" class="=btn btn-xs btn-info updatecart" style="height:20px;"
        ...
        <div class="col-md-5 pull-right">
            <ul class="list-group">
                ...
                <li class="list-group-item">
                    <span
                        class="badge"><?php $_SESSION['total'] = $_SESSION['tongtien'] * 105/100; echo formatPrice($_SESSION['total']) ?></span>
