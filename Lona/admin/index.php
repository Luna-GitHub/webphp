...
$con = mysqli_connect("localhost","root","","Lona");
                                            ...
                                            <div class="row no-gutters align-items-center">
                                                <div class="col mr-2">
                                                    <div
                                                        ...
                                                        Tổng Số Category</div>
                                                    <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                        <td><?php echo $row1; ?> Danh Mục Sản Phẩm</td>
                                                    </div>
                                                </div>
                                                <div class="col-auto">
                                            ...
                                            <div class="row no-gutters align-items-center">
                                                <div class="col mr-2">
                                                    <div
                                                        ...
                                                        Tổng Số User</div>
                                                    <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                        <td><?php echo $row3; ?> Thành Viên</td>
                                                    </div>
                                                </div>
                                                <div class="col-auto">
