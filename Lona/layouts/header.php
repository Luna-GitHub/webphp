...
<head>
    <title>Shop Lona</title>
    <meta charset="utf-8">
    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.6.1/css/all.css"
        integrity="sha384-gfdkjb5BdAXd+lj+gudLWI+BXq4IuLW5IT+brZEZsLFm++aCMlF1V92rMkPaX4PP" crossorigin="anonymous">
    <link rel="stylesheet" type="text/css" href="/Lona/public/frontend/css/font-awesome.min.css">
    <link rel="stylesheet" type="text/css" href="/Lona/public/frontend/css/bootstrap.min.css">
    <script src="/Lona/public/frontend/js/jquery-3.2.1.min.js"></script>
    <script src="/Lona/public/frontend/js/bootstrap.min.js"></script>
    <link rel="stylesheet" type="text/css" href="/Lona/public/frontend/css/slick.css" />
    <link rel="stylesheet" type="text/css" href="/Lona/public/frontend/css/slick-theme.css" />
    <link rel="stylesheet" type="text/css" href="/Lona/public/frontend/css/style.css">
                ...
                <div class="container">
                    <div class="row clearfix">
                        <div class="col-md-6" id="header-text">
                            <img src="./public/frontend/images/lona.png"/><b>Chào mừng bạn đến Shop Lona</b>
                        </div>
                        <div class="col-md-6">
                            <nav id="header-nav-top">
                                <ul class="list-inline pull-right" id="headermenu">
                                    ...
                                    <li style="border-left-width: 0px;">
                                        <a href="dang-nhap.php"><i class="fa fa-sign-in"
...
">
    ...
    width: 98%;">
                        <nav>
                            <div class=" pull-left" id="logo"><a href="index.php" title="ShopLona"><img
                                        src="./public/frontend/images/lona.png" width="180px" height="90px"
                                        alt="ShopLona"></a>
                            </div>
                            ...
                            <ul id="menu-main" style="padding-top:24px;text-decoration: none;display: inline-block;">
                                ...
                                <li>
                                    <a href="blog.php"
                                        style="background:white;color:#000000;border-right-width: 0px;text-decoration: none;font-size:14px;">Blog</a>
                                </li>
                                <li>
                            ...
                            <ul class="pull-right" id="main-shopping" style="margin-left: 0px;padding-top:24px;">
                                <li>
                                    <a href="gio-hang.php" style="background-color:black;border-radius:10px;margin-right:10px"><i
                                            class="fa fa-shopping-cart" style="background-color:black">
                                        </i>&nbsp;</a>
                                </li>
                            </ul>
